...
## Generated on : Thu Feb 29 19:00:27 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PF_core_control_msf.mexw64
...
MODELREF_LINK_RSPFILE     = PF_core_control_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PF_core_control_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/PF_core_control/PF_core_control_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = PF_core_control_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/Veimar/thirdequation.com/TNEI\ Model\ -\ Documents/MATLAB/FMU_lib/SH_ctrl/test_harness/slprj/sim/PF_core_control/PF_core_controllib.lib
...
PF_core_control_msf.obj : $(START_DIR)/slprj/sim/PF_core_control/PF_core_control_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
