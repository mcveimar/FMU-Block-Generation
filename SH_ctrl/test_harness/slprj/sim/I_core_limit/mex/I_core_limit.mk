...
## Generated on : Thu Feb 29 18:59:59 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/I_core_limit_msf.mexw64
...
MODELREF_LINK_RSPFILE     = I_core_limit_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/I_core_limit_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/I_core_limit/I_core_limit_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = I_core_limit_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/Veimar/thirdequation.com/TNEI\ Model\ -\ Documents/MATLAB/FMU_lib/SH_ctrl/test_harness/slprj/sim/I_core_limit/I_core_limitlib.lib
...
I_core_limit_msf.obj : $(START_DIR)/slprj/sim/I_core_limit/I_core_limit_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
