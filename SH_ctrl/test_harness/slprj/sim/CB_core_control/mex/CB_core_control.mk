...
## Generated on : Thu Feb 29 19:00:18 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/CB_core_control_msf.mexw64
...
MODELREF_LINK_RSPFILE     = CB_core_control_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/CB_core_control_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/CB_core_control/CB_core_control_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = CB_core_control_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/Veimar/thirdequation.com/TNEI\ Model\ -\ Documents/MATLAB/FMU_lib/SH_ctrl/test_harness/slprj/sim/CB_core_control/CB_core_controllib.lib
...
CB_core_control_msf.obj : $(START_DIR)/slprj/sim/CB_core_control/CB_core_control_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
