...
## Generated on : Thu Feb 29 18:59:38 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/HC_core_control_msf.mexw64
...
MODELREF_LINK_RSPFILE     = HC_core_control_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/HC_core_control_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/HC_core_control/HC_core_control_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = HC_core_control_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/Veimar/thirdequation.com/TNEI\ Model\ -\ Documents/MATLAB/FMU_lib/SH_ctrl/test_harness/slprj/sim/HC_core_control/HC_core_controllib.lib
...
HC_core_control_msf.obj : $(START_DIR)/slprj/sim/HC_core_control/HC_core_control_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
