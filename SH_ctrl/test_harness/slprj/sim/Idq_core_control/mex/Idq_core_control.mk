...
## Generated on : Thu Feb 29 19:00:09 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Idq_core_control_msf.mexw64
...
MODELREF_LINK_RSPFILE     = Idq_core_control_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Idq_core_control_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/Idq_core_control/Idq_core_control_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = Idq_core_control_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/Veimar/thirdequation.com/TNEI\ Model\ -\ Documents/MATLAB/FMU_lib/SH_ctrl/test_harness/slprj/sim/Idq_core_control/Idq_core_controllib.lib
...
Idq_core_control_msf.obj : $(START_DIR)/slprj/sim/Idq_core_control/Idq_core_control_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
