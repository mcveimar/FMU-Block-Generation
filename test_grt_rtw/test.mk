...
## 
## Makefile     : test.mk
## Generated on : Tue Jun 04 15:17:19 2024
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\test_grt_rtw\rtGetInf.c $(START_DIR)\test_grt_rtw\rtGetNaN.c $(START_DIR)\test_grt_rtw\rt_nonfinite.c $(START_DIR)\test_grt_rtw\test.c
...
OBJS = rt_logging.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj test.obj
...
{$(START_DIR)\test_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\test_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\test_grt_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\test_grt_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : "$(START_DIR)\test_grt_rtw\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\test_grt_rtw\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\test_grt_rtw\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\test_grt_rtw\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\test_grt_rtw\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\test_grt_rtw\rt_nonfinite.c"


test.obj : "$(START_DIR)\test_grt_rtw\test.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\test_grt_rtw\test.c"
