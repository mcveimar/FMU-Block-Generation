...
#define S_FUNCTION_NAME HC_core_control_msf
#endif
...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { gqeccqlb2tn * dw = (
gqeccqlb2tn * ) ssGetDWork ( S , 0 ) ; evefst11wn ( & ( dw -> rtdw ) ) ; }
static void mdlReset ( SimStruct * S ) { gqeccqlb2tn * dw = ( gqeccqlb2tn * )
ssGetDWork ( S , 0 ) ; d5qgjc3vsg ( & ( dw -> rtdw ) ) ; } static void
mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { gqeccqlb2tn * dw = (
gqeccqlb2tn * ) ssGetDWork ( S , 0 ) ; real32_T const * i_fyunmhyuc0 = (
real32_T * ) ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_mkbdkfhpu3 =
( real32_T * ) ssGetInputPortSignal ( S , 1 ) ; real32_T const * i_eqnjujtzaw
= ( real32_T * ) ssGetInputPortSignal ( S , 2 ) ; real32_T const *
i_oixiznwta0 = ( real32_T * ) ssGetInputPortSignal ( S , 3 ) ; real32_T const
* i_d2or5aomaj = ( real32_T * ) ssGetInputPortSignal ( S , 4 ) ; boolean_T
const * i_iapnowiorb = ( boolean_T * ) ssGetInputPortSignal ( S , 5 ) ;
real32_T * o_B_3_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ;
real32_T * o_B_3_2 = ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ; if (
tid == 0 ) { HC_core_control ( i_fyunmhyuc0 , i_mkbdkfhpu3 , i_eqnjujtzaw ,
i_oixiznwta0 , i_d2or5aomaj , i_iapnowiorb , o_B_3_1 , o_B_3_2 , & ( dw ->
rtb ) , & ( dw -> rtdw ) ) ; okjdub4pqr ( & ( dw -> rtb ) , & ( dw -> rtdw )
...
slmrInitializeIOPortDataVectors ( S , 6 , 2 ) ; if ( ! ssSetNumInputPorts ( S
...
ssSetInputPortOffsetTime ( S , 5 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 2
...
mr_HC_core_control_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
mr_HC_core_control_MdlInfoRegFcn ( S , "HC_core_control" , & retVal ) ; if (
! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( gqeccqlb2tn ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { gqeccqlb2tn * dw = (
gqeccqlb2tn * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } pv5ckujrfn
...
static void mdlOutputs ( SimStruct * S , int_T tid ) { gqeccqlb2tn * dw = (
gqeccqlb2tn * ) ssGetDWork ( S , 0 ) ; real32_T const * i_fyunmhyuc0 = (
real32_T * ) ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_mkbdkfhpu3 =
( real32_T * ) ssGetInputPortSignal ( S , 1 ) ; real32_T const * i_eqnjujtzaw
= ( real32_T * ) ssGetInputPortSignal ( S , 2 ) ; real32_T const *
...
PARAMETER_TUNING_TID ) { HC_core_control ( i_fyunmhyuc0 , i_mkbdkfhpu3 ,
i_eqnjujtzaw , i_oixiznwta0 , i_d2or5aomaj , i_iapnowiorb , o_B_3_1 , o_B_3_2
, & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { gqeccqlb2tn * dw = (
gqeccqlb2tn * ) ssGetDWork ( S , 0 ) ; okjdub4pqr ( & ( dw -> rtb ) , & ( dw
-> rtdw ) ) ; return ; } static void mdlTerminate ( SimStruct * S ) {
gqeccqlb2tn * dw = ( gqeccqlb2tn * ) ssGetDWork ( S , 0 ) ; m133vlzqvd ( & (
dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_HC_core_control_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_HC_core_control_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss
...
mr_HC_core_control_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss
