...
, 0.00025F , 0.0F , 0.0F , 0.0F , 0.0F , 0.00025F , 0.0F , 0.0F , 0.0F , 0.0F
, { - 20.0F , - 10.0F , 10.0F , 20.0F } , { - 15.0F , - 10.0F , 10.0F , 15.0F
} , 0.00025F , - 1.0F , 0.0F , 1 , - 1 , 1 , - 1 } ; void gjjqaawgpo (
b1rrm1enxt * const di4adofmaf , eucybaphjh * localDW ) { boolean_T tmp ;
localDW -> d4cbfpdwp1 [ 0 ] = nr0h43pjsz . P_18 ; localDW -> d4cbfpdwp1 [ 1 ]
= nr0h43pjsz . P_18 ; localDW -> f1q5n1mrk1 = 0 ; localDW -> pqmzu4crz5 = 1U
; if ( rtmIsFirstInitCond ( di4adofmaf ) ) { tmp =
...
kbadssudxg ( aijckfrqxd * localB ) { localB -> mhpfs1adwm [ 0 ] = 0.00025F ;
localB -> mhpfs1adwm [ 1 ] = 0.0F ; localB -> ec20qzqm0n [ 0 ] = 0.00025F ;
localB -> ec20qzqm0n [ 1 ] = 0.0F ; } void DC_core_control ( const real32_T *
kopfzko3w0 , const real32_T * isq2f2q3cs , const boolean_T * czhxjno0eu ,
real32_T * hhuwn1vhss , real32_T * ejb1rkl1c2 , real32_T * j05aud4mg5 ,
aijckfrqxd * localB , eucybaphjh * localDW ) { real32_T dsv0uor3df ; real32_T
alkaerh555 ; real32_T jdzpd022y5 ; real32_T k4kbkojdnp_p ; real32_T
mdlqudn4z1 ; real32_T pxsojhxqlt ; int8_T tmp ; int8_T tmp_p ; localB ->
h3z3xa1nli = ( ( ( real32_T ) ( nr0h43pjsz . P_0 - localB -> mhpfs1adwm [ 0 ]
) <= nr0h43pjsz . P_14 ) && localB -> edkuo3j5s3 ) ; localB -> jhoo1p3ue5 = (
( ( real32_T ) ( nr0h43pjsz . P_1 - localB -> ec20qzqm0n [ 0 ] ) <=
nr0h43pjsz . P_15 ) && localB -> h5emfzxn1o ) ; k4kbkojdnp_p = * kopfzko3w0 ;
k4kbkojdnp_p -= localDW -> d4cbfpdwp1 [ 0 ] * nr0h43pjsz . P_17 [ 1 ] ;
k4kbkojdnp_p -= localDW -> d4cbfpdwp1 [ 1 ] * nr0h43pjsz . P_17 [ 2 ] ;
localDW -> dgtugyve3p = k4kbkojdnp_p / nr0h43pjsz . P_17 [ 0 ] ; k4kbkojdnp_p
= ( ( nr0h43pjsz . P_16 [ 0 ] * localDW -> dgtugyve3p + localDW -> d4cbfpdwp1
[ 0 ] * nr0h43pjsz . P_16 [ 1 ] ) + localDW -> d4cbfpdwp1 [ 1 ] * nr0h43pjsz
. P_16 [ 2 ] ) * nr0h43pjsz . P_8 ; if ( localDW -> pqmzu4crz5 != 0 ) {
localDW -> j2kv1drnk1 = k4kbkojdnp_p ; if ( localDW -> j2kv1drnk1 >
nr0h43pjsz . P_20 ) { localDW -> j2kv1drnk1 = nr0h43pjsz . P_20 ; } else if (
localDW -> j2kv1drnk1 < nr0h43pjsz . P_21 ) { localDW -> j2kv1drnk1 =
nr0h43pjsz . P_21 ; } } if ( localB -> jhoo1p3ue5 || ( localDW -> f1q5n1mrk1
!= 0 ) ) { localDW -> j2kv1drnk1 = k4kbkojdnp_p ; if ( localDW -> j2kv1drnk1
> nr0h43pjsz . P_20 ) { localDW -> j2kv1drnk1 = nr0h43pjsz . P_20 ; } else if
( localDW -> j2kv1drnk1 < nr0h43pjsz . P_21 ) { localDW -> j2kv1drnk1 =
nr0h43pjsz . P_21 ; } } if ( localDW -> j2kv1drnk1 > nr0h43pjsz . P_22 ) { *
hhuwn1vhss = nr0h43pjsz . P_22 ; } else if ( localDW -> j2kv1drnk1 <
nr0h43pjsz . P_23 ) { * hhuwn1vhss = nr0h43pjsz . P_23 ; } else { *
hhuwn1vhss = localDW -> j2kv1drnk1 ; } if ( * czhxjno0eu ) { mdlqudn4z1 = *
isq2f2q3cs ; } else { mdlqudn4z1 = * hhuwn1vhss ; } mdlqudn4z1 *= nr0h43pjsz
. P_9 ; if ( localDW -> ey2omfatnv != 0 ) { localDW -> bsxapokqfo =
mdlqudn4z1 ; if ( localDW -> bsxapokqfo > nr0h43pjsz . P_25 ) { localDW ->
bsxapokqfo = nr0h43pjsz . P_25 ; } else if ( localDW -> bsxapokqfo <
...
SimStruct * S ) { const uint32_T chksum [ 4 ] = { 1636691424U , 2535314055U ,
3302197960U , 3008491155U , } ; slmrModelRefRegisterSimStateChecksum ( S ,
