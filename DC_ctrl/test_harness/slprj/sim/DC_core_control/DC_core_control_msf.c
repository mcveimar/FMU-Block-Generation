...
false ) ; ssSetInputPortSampleTime ( S , 0 , 0.00025 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 1 , 0.00025 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 2 , 0.00025 ) ;
...
unitIdReg ) ;
#endif
} ssSetOutputPortSampleTime ( S , 1 , 0.00025 ) ; ssSetOutputPortOffsetTime (
...
unitIdReg ) ;
#endif
} ssSetOutputPortSampleTime ( S , 2 , 0.00025 ) ; ssSetOutputPortOffsetTime (
...
mr_DC_core_control_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
0.00025 ) ; ssSetOffsetTime ( S , 0 , 0 ) ; ssSetSampleTime ( S , 1 ,
