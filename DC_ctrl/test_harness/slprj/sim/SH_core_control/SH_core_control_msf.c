...
i_ftu2vad55o = ( real32_T * ) ssGetInputPortSignal ( S , 11 ) ; real32_T *
...
o_B_1_1 , o_B_1_2 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; ktdw0mx3kq ( & (
dw -> rtm ) , i_i_gknb0a3r3l , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } }
...
slmrInitializeIOPortDataVectors ( S , 12 , 2 ) ; if ( ! ssSetNumInputPorts (
S , 12 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 3 ) )
...
false ) ; ssSetInputPortSampleTime ( S , 4 , 0.00025 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 5 , 0.00025 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 6 , 0.00025 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 7 , 0.008 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 8 , 0.008 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 9 , 0.008 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 10 , 0.008 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 11 , 0.008 ) ;
...
unitIdReg ) ;
#endif
} ssSetOutputPortSampleTime ( S , 0 , 0.00025 ) ; ssSetOutputPortOffsetTime (
...
mr_SH_core_control_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
ssSetSampleTime ( S , 0 , 0.00025 ) ; ssSetOffsetTime ( S , 0 , 0 ) ;
ssSetSampleTime ( S , 1 , 0.008 ) ; ssSetOffsetTime ( S , 1 , 0 ) ;
...
i_jnbhzwkkn3 , i_chfvla4dml , i_ftu2vad55o , o_B_1_1 , o_B_1_2 , & ( dw ->
rtb ) , & ( dw -> rtdw ) ) ; } }
#define MDL_UPDATE
