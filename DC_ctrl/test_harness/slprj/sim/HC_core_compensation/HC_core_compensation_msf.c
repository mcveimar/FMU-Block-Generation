...
#define S_FUNCTION_NAME HC_core_compensation_msf
#endif
...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { blwxvi3q3iv * dw = (
blwxvi3q3iv * ) ssGetDWork ( S , 0 ) ; lbv5mhn4ns ( & ( dw -> rtdw ) ) ; }
static void mdlReset ( SimStruct * S ) { blwxvi3q3iv * dw = ( blwxvi3q3iv * )
ssGetDWork ( S , 0 ) ; cmy5t3htxp ( & ( dw -> rtdw ) ) ; } static void
mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { blwxvi3q3iv * dw = (
blwxvi3q3iv * ) ssGetDWork ( S , 0 ) ; real32_T const * i_jss223nufz = (
real32_T * ) ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_jzvrlobfjv =
( real32_T * ) ssGetInputPortSignal ( S , 1 ) ; boolean_T const *
i_hmn1or4vfz = ( boolean_T * ) ssGetInputPortSignal ( S , 2 ) ; real32_T
const * i_b3tqlvbagd = ( real32_T * ) ssGetInputPortSignal ( S , 3 ) ;
real32_T const * i_a3iujnrmc3 = ( real32_T * ) ssGetInputPortSignal ( S , 4 )
; real32_T const * i_k2hzyuvttp = ( real32_T * ) ssGetInputPortSignal ( S , 5
) ; real32_T const * i_kp5h2lmpir = ( real32_T * ) ssGetInputPortSignal ( S ,
...
tid == 0 ) { HC_core_compensation ( i_jss223nufz , i_jzvrlobfjv ,
i_hmn1or4vfz , i_b3tqlvbagd , i_a3iujnrmc3 , i_k2hzyuvttp , i_kp5h2lmpir ,
o_B_1_1 , o_B_1_2 , o_B_1_3 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ;
cciap5ge1t ( & ( dw -> rtdw ) ) ; } } static void mdlInitializeSizes (
...
false ) ; ssSetInputPortSampleTime ( S , 6 , 0.008 ) ;
ssSetInputPortOffsetTime ( S , 6 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 3
...
mr_HC_core_compensation_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes
...
mr_HC_core_compensation_MdlInfoRegFcn ( S , "HC_core_compensation" , & retVal
) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( blwxvi3q3iv ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { blwxvi3q3iv * dw = (
blwxvi3q3iv * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } itjrbl0ose
...
-> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { blwxvi3q3iv * dw = ( blwxvi3q3iv * )
ssGetDWork ( S , 0 ) ; mdlProcessParameters ( S ) ; pcdmbxaabi ( & ( dw ->
rtdw ) ) ; } static void mdlOutputs ( SimStruct * S , int_T tid ) {
blwxvi3q3iv * dw = ( blwxvi3q3iv * ) ssGetDWork ( S , 0 ) ; real32_T const *
i_jss223nufz = ( real32_T * ) ssGetInputPortSignal ( S , 0 ) ; real32_T const
* i_jzvrlobfjv = ( real32_T * ) ssGetInputPortSignal ( S , 1 ) ; boolean_T
const * i_hmn1or4vfz = ( boolean_T * ) ssGetInputPortSignal ( S , 2 ) ;
real32_T const * i_b3tqlvbagd = ( real32_T * ) ssGetInputPortSignal ( S , 3 )
; real32_T const * i_a3iujnrmc3 = ( real32_T * ) ssGetInputPortSignal ( S , 4
) ; real32_T const * i_k2hzyuvttp = ( real32_T * ) ssGetInputPortSignal ( S ,
5 ) ; real32_T const * i_kp5h2lmpir = ( real32_T * ) ssGetInputPortSignal ( S
, 6 ) ; real32_T * o_B_1_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ;
real32_T * o_B_1_2 = ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ;
real32_T * o_B_1_3 = ( real32_T * ) ssGetOutputPortSignal ( S , 2 ) ; if (
tid == PARAMETER_TUNING_TID ) { } if ( tid != CONSTANT_TID && tid !=
PARAMETER_TUNING_TID ) { HC_core_compensation ( i_jss223nufz , i_jzvrlobfjv ,
i_hmn1or4vfz , i_b3tqlvbagd , i_a3iujnrmc3 , i_k2hzyuvttp , i_kp5h2lmpir ,
o_B_1_1 , o_B_1_2 , o_B_1_3 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { blwxvi3q3iv * dw = (
blwxvi3q3iv * ) ssGetDWork ( S , 0 ) ; cciap5ge1t ( & ( dw -> rtdw ) ) ;
return ; } static void mdlTerminate ( SimStruct * S ) { blwxvi3q3iv * dw = (
blwxvi3q3iv * ) ssGetDWork ( S , 0 ) ; nmlvnzjiku ( & ( dw -> rtdw ) , & ( dw
-> rtm ) ) ; return ; }
...
mdlrefDW = mr_HC_core_compensation_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_HC_core_compensation_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber
...
mr_HC_core_compensation_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber
