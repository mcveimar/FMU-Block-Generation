...
uint32_T chksum [ 4 ] = { 908616729U , 224517566U , 1008353189U , 2383619637U
, } ; slmrModelRefRegisterSimStateChecksum ( S , "LC_core_control" , & chksum
[ 0 ] ) ; mr_CB_core_control_RegisterSimStateChecksum ( S ) ;
