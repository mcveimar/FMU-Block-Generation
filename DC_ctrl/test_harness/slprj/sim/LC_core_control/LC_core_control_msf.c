...
#define S_FUNCTION_NAME LC_core_control_msf
#endif
...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { jfe402omtci * dw = (
jfe402omtci * ) ssGetDWork ( S , 0 ) ; oy0qujxpgs ( & ( dw -> rtdw ) ) ; }
static void mdlReset ( SimStruct * S ) { jfe402omtci * dw = ( jfe402omtci * )
ssGetDWork ( S , 0 ) ; ekvlsf2l1w ( & ( dw -> rtdw ) ) ; } static void
mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { jfe402omtci * dw = (
jfe402omtci * ) ssGetDWork ( S , 0 ) ; real32_T const * i_lpe11uykk3 = (
real32_T * ) ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_erqpm3qm2h =
( real32_T * ) ssGetInputPortSignal ( S , 1 ) ; boolean_T const *
i_clbbnf2h0n = ( boolean_T * ) ssGetInputPortSignal ( S , 2 ) ; real32_T
const * i_agx2v3swew = ( real32_T * ) ssGetInputPortSignal ( S , 3 ) ;
real32_T const * i_e3j4nmmexc = ( real32_T * ) ssGetInputPortSignal ( S , 4 )
; boolean_T const * i_iob10bahaw = ( boolean_T * ) ssGetInputPortSignal ( S ,
5 ) ; real32_T * o_B_1_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ;
real32_T * o_B_1_2 = ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ;
real32_T * o_B_1_3 = ( real32_T * ) ssGetOutputPortSignal ( S , 2 ) ;
real32_T * o_B_1_4 = ( real32_T * ) ssGetOutputPortSignal ( S , 3 ) ; if (
tid == 0 ) { LC_core_control ( i_lpe11uykk3 , i_erqpm3qm2h , i_clbbnf2h0n ,
i_agx2v3swew , i_e3j4nmmexc , i_iob10bahaw , o_B_1_1 , o_B_1_2 , o_B_1_3 ,
o_B_1_4 , & ( dw -> rtdw ) ) ; kstupqmgsy ( & ( dw -> rtdw ) ) ; } } static
...
slmrInitializeIOPortDataVectors ( S , 6 , 4 ) ; if ( ! ssSetNumInputPorts ( S
...
false ) ; ssSetInputPortSampleTime ( S , 0 , 0.008 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 1 , 0.008 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 2 , 0.008 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 3 , 0.008 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 4 , 0.008 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 5 , 0.008 ) ;
ssSetInputPortOffsetTime ( S , 5 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 4
...
unitIdReg ) ;
#endif
} ssSetOutputPortSampleTime ( S , 0 , 0.008 ) ; ssSetOutputPortOffsetTime ( S
...
unitIdReg ) ;
#endif
} ssSetOutputPortSampleTime ( S , 1 , 0.008 ) ; ssSetOutputPortOffsetTime ( S
...
unitIdReg ) ;
#endif
} ssSetOutputPortSampleTime ( S , 2 , 0.008 ) ; ssSetOutputPortOffsetTime ( S
...
unitIdReg ) ;
#endif
} ssSetOutputPortSampleTime ( S , 3 , 0.008 ) ; ssSetOutputPortOffsetTime ( S
...
mr_LC_core_control_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
mr_LC_core_control_MdlInfoRegFcn ( S , "LC_core_control" , & retVal ) ; if (
! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( jfe402omtci ) ) )
...
mdlInitializeSampleTimes ( SimStruct * S ) { ssSetSampleTime ( S , 0 , 0.008
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { jfe402omtci * dw = (
jfe402omtci * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } fhctpdvbbm
...
genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { jfe402omtci * dw = ( jfe402omtci * )
ssGetDWork ( S , 0 ) ; hefhsp2lgr ( & ( dw -> rtdw ) ) ; } static void
mdlOutputs ( SimStruct * S , int_T tid ) { jfe402omtci * dw = ( jfe402omtci *
) ssGetDWork ( S , 0 ) ; real32_T const * i_lpe11uykk3 = ( real32_T * )
ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_erqpm3qm2h = ( real32_T *
) ssGetInputPortSignal ( S , 1 ) ; boolean_T const * i_clbbnf2h0n = (
boolean_T * ) ssGetInputPortSignal ( S , 2 ) ; real32_T const * i_agx2v3swew
= ( real32_T * ) ssGetInputPortSignal ( S , 3 ) ; real32_T const *
i_e3j4nmmexc = ( real32_T * ) ssGetInputPortSignal ( S , 4 ) ; boolean_T
const * i_iob10bahaw = ( boolean_T * ) ssGetInputPortSignal ( S , 5 ) ;
real32_T * o_B_1_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ;
real32_T * o_B_1_2 = ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ;
real32_T * o_B_1_3 = ( real32_T * ) ssGetOutputPortSignal ( S , 2 ) ;
real32_T * o_B_1_4 = ( real32_T * ) ssGetOutputPortSignal ( S , 3 ) ; if (
tid == PARAMETER_TUNING_TID ) { LC_core_controlTID1 ( & ( dw -> rtdw ) ) ; }
if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { LC_core_control (
i_lpe11uykk3 , i_erqpm3qm2h , i_clbbnf2h0n , i_agx2v3swew , i_e3j4nmmexc ,
i_iob10bahaw , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , & ( dw -> rtdw ) ) ; }
}
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { jfe402omtci * dw = (
jfe402omtci * ) ssGetDWork ( S , 0 ) ; kstupqmgsy ( & ( dw -> rtdw ) ) ;
return ; } static void mdlTerminate ( SimStruct * S ) { jfe402omtci * dw = (
jfe402omtci * ) ssGetDWork ( S , 0 ) ; nan4o5p35k ( & ( dw -> rtdw ) , & ( dw
-> rtm ) ) ; return ; }
...
mdlrefDW = mr_LC_core_control_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_LC_core_control_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss
...
mr_LC_core_control_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss
