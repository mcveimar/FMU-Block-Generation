...
; ssSetInputPortSampleTime ( S , 0 , 0.008 ) ; ssSetInputPortOffsetTime ( S ,
0 , 0.0 ) ; if ( ! ssSetInputPortMatrixDimensions ( S , 1 , 3 , 6 ) ) return
...
; ssSetInputPortSampleTime ( S , 1 , 0.008 ) ; ssSetInputPortOffsetTime ( S ,
...
; ssSetInputPortSampleTime ( S , 3 , 0.008 ) ; ssSetInputPortOffsetTime ( S ,
3 , 0.0 ) ; if ( ! ssSetInputPortMatrixDimensions ( S , 4 , 3 , 6 ) ) return
...
; ssSetInputPortSampleTime ( S , 4 , 0.008 ) ; ssSetInputPortOffsetTime ( S ,
4 , 0.0 ) ; if ( ! ssSetInputPortMatrixDimensions ( S , 5 , 3 , 6 ) ) return
...
; ssSetInputPortSampleTime ( S , 5 , 0.008 ) ; ssSetInputPortOffsetTime ( S ,
5 , 0.0 ) ; if ( ! ssSetInputPortMatrixDimensions ( S , 6 , 3 , 6 ) ) return
...
; ssSetInputPortSampleTime ( S , 6 , 0.008 ) ; ssSetInputPortOffsetTime ( S ,
6 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 3 ) ) return ; if ( !
...
ssSetOutputPortMatrixDimensions ( S , 1 , 3 , 6 ) ) return ;
...
ssSetOutputPortMatrixDimensions ( S , 2 , 3 , 6 ) ) return ;
