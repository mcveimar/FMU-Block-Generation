...
#define S_FUNCTION_NAME PF_core_control_msf
#endif
...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { ckurqr25mlp * dw = (
ckurqr25mlp * ) ssGetDWork ( S , 0 ) ; e5ef2ozw0e ( & ( dw -> rtm ) , & ( dw
-> rtdw ) ) ; } static void mdlReset ( SimStruct * S ) { ckurqr25mlp * dw = (
ckurqr25mlp * ) ssGetDWork ( S , 0 ) ; k2dpjuoiat ( & ( dw -> rtm ) , & ( dw
-> rtdw ) ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T
tid ) { ckurqr25mlp * dw = ( ckurqr25mlp * ) ssGetDWork ( S , 0 ) ; real32_T
const * i_dkrcb5texv = ( real32_T * ) ssGetInputPortSignal ( S , 0 ) ;
real32_T const * i_nx5e5qiqx5 = ( real32_T * ) ssGetInputPortSignal ( S , 1 )
; boolean_T const * i_ajnijijvtm = ( boolean_T * ) ssGetInputPortSignal ( S ,
2 ) ; real32_T * o_B_2_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ;
real32_T * o_B_2_2 = ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ; if (
tid == 0 ) { PF_core_control ( i_dkrcb5texv , i_nx5e5qiqx5 , i_ajnijijvtm ,
o_B_2_1 , o_B_2_2 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; a0j5ozku0y ( & (
...
ssSetInputPortOffsetTime ( S , 2 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 2
...
mr_PF_core_control_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
mr_PF_core_control_MdlInfoRegFcn ( S , "PF_core_control" , & retVal ) ; if (
! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( ckurqr25mlp ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { ckurqr25mlp * dw = (
ckurqr25mlp * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } f0mfj1yok3
...
-> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { ckurqr25mlp * dw = ( ckurqr25mlp * )
ssGetDWork ( S , 0 ) ; icujx3cwz1 ( & ( dw -> rtb ) ) ; } static void
mdlOutputs ( SimStruct * S , int_T tid ) { ckurqr25mlp * dw = ( ckurqr25mlp *
) ssGetDWork ( S , 0 ) ; real32_T const * i_dkrcb5texv = ( real32_T * )
ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_nx5e5qiqx5 = ( real32_T *
) ssGetInputPortSignal ( S , 1 ) ; boolean_T const * i_ajnijijvtm = (
boolean_T * ) ssGetInputPortSignal ( S , 2 ) ; real32_T * o_B_2_1 = (
real32_T * ) ssGetOutputPortSignal ( S , 0 ) ; real32_T * o_B_2_2 = (
real32_T * ) ssGetOutputPortSignal ( S , 1 ) ; if ( tid ==
PARAMETER_TUNING_TID ) { PF_core_controlTID1 ( & ( dw -> rtb ) ) ; } if ( tid
!= CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { PF_core_control (
i_dkrcb5texv , i_nx5e5qiqx5 , i_ajnijijvtm , o_B_2_1 , o_B_2_2 , & ( dw ->
rtb ) , & ( dw -> rtdw ) ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { ckurqr25mlp * dw = (
ckurqr25mlp * ) ssGetDWork ( S , 0 ) ; a0j5ozku0y ( & ( dw -> rtb ) , & ( dw
-> rtdw ) ) ; return ; } static void mdlTerminate ( SimStruct * S ) {
ckurqr25mlp * dw = ( ckurqr25mlp * ) ssGetDWork ( S , 0 ) ; ci4xki353t ( & (
dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_PF_core_control_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_PF_core_control_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss
...
mr_PF_core_control_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss
