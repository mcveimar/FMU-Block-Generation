...
ssSetOutputPortICAttributes ( S , 1 , false , true , true ) ;
...
mr_I_core_limit_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S , 2
...
ssSetSampleTime ( S , 0 , 0.008 ) ; ssSetOffsetTime ( S , 0 , 0 ) ;
