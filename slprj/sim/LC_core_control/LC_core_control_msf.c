...
false ) ; ssSetInputPortSampleTime ( S , 4 , 0.00853344 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 5 , 0.00853344 ) ;
...
USE_CUSTOM_SIM_STATE ) ; mr_LC_core_control_RegisterSimStateChecksum ( S ) ;
