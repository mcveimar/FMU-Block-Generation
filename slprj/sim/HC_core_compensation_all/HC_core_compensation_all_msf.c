...
#define S_FUNCTION_NAME HC_core_compensation_all_msf
#endif
...
memcpy ( & ( rtP__shuntMaxRequestedCurrentrms2f2fmuGenerationDictionay_sldd_
) , GlobalPrm_0 , sizeof ( real32_T ) ) ; } }
#endif
static void mdlInitializeConditions ( SimStruct * S ) { otekkx3ztfm * dw = (
otekkx3ztfm * ) ssGetDWork ( S , 0 ) ; k1zlgnkq11 ( & ( dw -> rtdw ) ) ; }
static void mdlReset ( SimStruct * S ) { otekkx3ztfm * dw = ( otekkx3ztfm * )
ssGetDWork ( S , 0 ) ; d0i35w3ede ( & ( dw -> rtdw ) ) ; } static void
mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { otekkx3ztfm * dw = (
otekkx3ztfm * ) ssGetDWork ( S , 0 ) ; real32_T const * i_hhvb5mxh5m = (
real32_T * ) ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_kk1lxrsltl =
( real32_T * ) ssGetInputPortSignal ( S , 1 ) ; boolean_T const *
i_mqnheqojpj = ( boolean_T * ) ssGetInputPortSignal ( S , 2 ) ; real32_T
const * i_nbxqpr1uzb = ( real32_T * ) ssGetInputPortSignal ( S , 3 ) ;
real32_T const * i_di2nd0m3kj = ( real32_T * ) ssGetInputPortSignal ( S , 4 )
; real32_T const * i_jjznkyab1h = ( real32_T * ) ssGetInputPortSignal ( S , 5
) ; real32_T const * i_ndh02yyvnj = ( real32_T * ) ssGetInputPortSignal ( S ,
6 ) ; real32_T * o_B_1_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ;
real32_T * o_B_1_2 = ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ;
real32_T * o_B_1_3 = ( real32_T * ) ssGetOutputPortSignal ( S , 2 ) ; if (
tid == 0 ) { HC_core_compensation_all ( i_hhvb5mxh5m , i_kk1lxrsltl ,
i_mqnheqojpj , i_nbxqpr1uzb , i_di2nd0m3kj , i_jjznkyab1h , i_ndh02yyvnj ,
o_B_1_1 , o_B_1_2 , o_B_1_3 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ;
d5cxoj21dh ( & ( dw -> rtdw ) ) ; } } static void mdlInitializeSizes (
...
7 , 3 ) ; if ( ! ssSetNumInputPorts ( S , 7 ) ) return ; if ( !
ssSetInputPortMatrixDimensions ( S , 0 , 3 , 6 ) ) return ;
...
; ssSetInputPortSampleTime ( S , 0 , 0.00853344 ) ; ssSetInputPortOffsetTime
( S , 0 , 0.0 ) ; if ( ! ssSetInputPortMatrixDimensions ( S , 1 , 3 , 6 ) )
...
; ssSetInputPortSampleTime ( S , 1 , 0.00853344 ) ; ssSetInputPortOffsetTime
...
ssSetInputPortVectorDimension ( S , 3 , 6 ) ) return ;
...
; ssSetInputPortSampleTime ( S , 3 , 0.00853344 ) ; ssSetInputPortOffsetTime
( S , 3 , 0.0 ) ; if ( ! ssSetInputPortMatrixDimensions ( S , 4 , 3 , 6 ) )
...
; ssSetInputPortSampleTime ( S , 4 , 0.00853344 ) ; ssSetInputPortOffsetTime
( S , 4 , 0.0 ) ; if ( ! ssSetInputPortMatrixDimensions ( S , 5 , 3 , 6 ) )
...
; ssSetInputPortSampleTime ( S , 5 , 0.00853344 ) ; ssSetInputPortOffsetTime
( S , 5 , 0.0 ) ; if ( ! ssSetInputPortMatrixDimensions ( S , 6 , 3 , 6 ) )
...
; ssSetInputPortSampleTime ( S , 6 , 0.00853344 ) ; ssSetInputPortOffsetTime
( S , 6 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 3 ) ) return ; if ( !
ssSetOutputPortMatrixDimensions ( S , 0 , 3 , 6 ) ) return ;
...
SS_NOT_REUSABLE_AND_LOCAL ) ; if ( ! ssSetOutputPortMatrixDimensions ( S , 1
, 3 , 6 ) ) return ; ssSetOutputPortDimensionsMode ( S , 1 , FIXED_DIMS_MODE
...
SS_NOT_REUSABLE_AND_LOCAL ) ; if ( ! ssSetOutputPortMatrixDimensions ( S , 2
, 3 , 6 ) ) return ; ssSetOutputPortDimensionsMode ( S , 2 , FIXED_DIMS_MODE
...
USE_CUSTOM_SIM_STATE ) ; mr_HC_core_compensation_all_RegisterSimStateChecksum
( S ) ; ssSetNumSampleTimes ( S , 2 ) ; ssSetParameterTuningCompliance ( S ,
true ) ; ssSetNumRWork ( S , 0 ) ; ssSetNumIWork ( S , 0 ) ; ssSetNumPWork (
S , 0 ) ; ssSetNumModes ( S , 0 ) ; { int_T zcsIdx = 0 ; }
...
mr_HC_core_compensation_all_MdlInfoRegFcn ( S , "HC_core_compensation_all" ,
& retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( otekkx3ztfm ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { otekkx3ztfm * dw = (
otekkx3ztfm * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } cezqaqh0pi
...
-> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { otekkx3ztfm * dw = ( otekkx3ztfm * )
ssGetDWork ( S , 0 ) ; mdlProcessParameters ( S ) ; i5ltjfz1ee ( & ( dw ->
rtdw ) ) ; } static void mdlOutputs ( SimStruct * S , int_T tid ) {
otekkx3ztfm * dw = ( otekkx3ztfm * ) ssGetDWork ( S , 0 ) ; real32_T const *
i_hhvb5mxh5m = ( real32_T * ) ssGetInputPortSignal ( S , 0 ) ; real32_T const
* i_kk1lxrsltl = ( real32_T * ) ssGetInputPortSignal ( S , 1 ) ; boolean_T
const * i_mqnheqojpj = ( boolean_T * ) ssGetInputPortSignal ( S , 2 ) ;
real32_T const * i_nbxqpr1uzb = ( real32_T * ) ssGetInputPortSignal ( S , 3 )
; real32_T const * i_di2nd0m3kj = ( real32_T * ) ssGetInputPortSignal ( S , 4
) ; real32_T const * i_jjznkyab1h = ( real32_T * ) ssGetInputPortSignal ( S ,
5 ) ; real32_T const * i_ndh02yyvnj = ( real32_T * ) ssGetInputPortSignal ( S
, 6 ) ; real32_T * o_B_1_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ;
real32_T * o_B_1_2 = ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ;
real32_T * o_B_1_3 = ( real32_T * ) ssGetOutputPortSignal ( S , 2 ) ; if (
tid == PARAMETER_TUNING_TID ) { } if ( tid != CONSTANT_TID && tid !=
PARAMETER_TUNING_TID ) { HC_core_compensation_all ( i_hhvb5mxh5m ,
i_kk1lxrsltl , i_mqnheqojpj , i_nbxqpr1uzb , i_di2nd0m3kj , i_jjznkyab1h ,
i_ndh02yyvnj , o_B_1_1 , o_B_1_2 , o_B_1_3 , & ( dw -> rtb ) , & ( dw -> rtdw
) ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { otekkx3ztfm * dw = (
otekkx3ztfm * ) ssGetDWork ( S , 0 ) ; d5cxoj21dh ( & ( dw -> rtdw ) ) ;
return ; } static void mdlTerminate ( SimStruct * S ) { otekkx3ztfm * dw = (
otekkx3ztfm * ) ssGetDWork ( S , 0 ) ; gefkexhyzf ( & ( dw -> rtdw ) , & ( dw
-> rtm ) ) ; return ; }
...
mdlrefDW = mr_HC_core_compensation_all_GetDWork ( ssGetDWork ( S , 0 ) ) ;
...
mr_HC_core_compensation_all_SetDWork ( ssGetDWork ( S , 0 ) ,
