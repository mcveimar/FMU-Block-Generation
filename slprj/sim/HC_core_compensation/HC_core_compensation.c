...
uint32_T chksum [ 4 ] = { 4287128538U , 620163842U , 2916072990U ,
1153045082U , } ; slmrModelRefRegisterSimStateChecksum ( S ,
"HC_core_compensation" , & chksum [ 0 ] ) ;
mr_HC_core_control_RegisterSimStateChecksum ( S ) ;
