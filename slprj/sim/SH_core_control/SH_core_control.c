...
static RegMdlInfo rtMdlInfo_SH_core_control [ 50 ] = { { "ooosbidteo0" ,
...
- 1 , ( void * ) "SH_core_control" } , { "pqgg0s5mnwe" ,
MDL_INFO_ID_DATA_TYPE , 0 , - 1 , ( NULL ) } , { "otekkx3ztfm" ,
...
localB -> g5qpgrulyl [ 0 ] , & localB -> gn3eogbz4c [ 0 ] , & ( localDW ->
piei4df4ag . rtb ) , & ( localDW -> piei4df4ag . rtdw ) ) ; fpnmyyhukc ( & (
localDW -> cv5n1d2u0p . rtdw ) ) ; } void pvt2bnlwf0 ( o0dgt5t3tx * localDW )
{ int32_T i ; for ( i = 0 ; i < 18 ; i ++ ) { localDW -> nng2bawhua [ i ] =
oywvaua2qy . P_2 ; } localDW -> aa5ydd4hrb [ 0 ] = oywvaua2qy . P_3 ; localDW
-> dutdlgd5uj [ 0 ] = oywvaua2qy . P_4 ; localDW -> aa5ydd4hrb [ 1 ] =
oywvaua2qy . P_3 ; localDW -> dutdlgd5uj [ 1 ] = oywvaua2qy . P_4 ; localDW
-> aa5ydd4hrb [ 2 ] = oywvaua2qy . P_3 ; localDW -> dutdlgd5uj [ 2 ] =
oywvaua2qy . P_4 ; ekvlsf2l1w ( & ( localDW -> etqgqqb2ch . rtdw ) ) ;
kzeaax43ft ( & ( localDW -> fj2mqrj3is . rtm ) , & ( localDW -> fj2mqrj3is .
rtdw ) ) ; d0i35w3ede ( & ( localDW -> ceec0oyspz . rtdw ) ) ; cfngso15cx ( &
( localDW -> cv5n1d2u0p . rtdw ) ) ; } void bsppiyrk1l ( ftsh5sbept * localB
, o0dgt5t3tx * localDW ) { g1dg5uroo3 ( & localB -> gn3eogbz4c [ 0 ] , & (
localDW -> piei4df4ag . rtb ) , & ( localDW -> piei4df4ag . rtdw ) ) ; } void
nrb52ovgbk ( o0dgt5t3tx * localDW ) { hefhsp2lgr ( & ( localDW -> etqgqqb2ch
. rtdw ) ) ; plud4shqa4 ( & ( localDW -> piei4df4ag . rtb ) ) ; kbadssudxg (
& ( localDW -> fj2mqrj3is . rtb ) ) ; i5ltjfz1ee ( & ( localDW -> ceec0oyspz
. rtdw ) ) ; } void SH_core_control ( g0zk2atzxj * const ob2yydonjz , const
real32_T eqhwqmkirz [ 3 ] , const boolean_T * hf3ixuspm0 , const real32_T
krb0v5ajkv [ 3 ] , const boolean_T * f5cfhvhrbc , const real32_T * ovryma2hyb
, const real32_T * jfi3kzdglc , const boolean_T * ol11pn4kwk , const
boolean_T * jb0o103acl , const real32_T cpyvmcwh5j [ 18 ] , const real32_T
lawg0znqbs [ 18 ] , const real32_T flqoyfer1o [ 18 ] , const real32_T
gegp3clne1 [ 18 ] , const boolean_T * alxctb32kf , const real32_T nrxmxjtuyd
[ 3 ] , const real32_T cezjmq5x5p [ 3 ] , const real32_T jwyg0c0j3g [ 3 ] ,
const real32_T bd1l2vd1co [ 3 ] , const real32_T aekw34ae0j [ 3 ] , const
real32_T jvffilbxtv [ 3 ] , real32_T gftynocchu [ 3 ] , real32_T md2xx4ryau [
3 ] , ftsh5sbept * localB , o0dgt5t3tx * localDW ) { real32_T ln0dqujal1 [ 3
] ; real32_T gitnbltvi4 [ 3 ] ; real32_T i0etnm3dja ; real32_T h50zc0nhds ;
real32_T itjeggky5b ; real32_T a33f40die0 [ 18 ] ; real32_T ca0kl33vdf [ 18 ]
; real32_T gvlxlfgdtw [ 18 ] ; real32_T jb2n1bdqh4 [ 3 ] ; if (
rtmIsSampleHit ( ob2yydonjz , 1 , 0 ) ) { memcpy ( & localB -> dgg0ublhbc [ 0
] , & localDW -> nng2bawhua [ 0 ] , 18U * sizeof ( real32_T ) ) ; localB ->
lqqbomot3p [ 0 ] = localDW -> aa5ydd4hrb [ 0 ] ; localB -> lqqbomot3p [ 1 ] =
localDW -> aa5ydd4hrb [ 1 ] ; localB -> lqqbomot3p [ 2 ] = localDW ->
aa5ydd4hrb [ 2 ] ; localB -> m1dnlxpmmu [ 0 ] = localDW -> dutdlgd5uj [ 0 ] ;
localB -> m1dnlxpmmu [ 1 ] = localDW -> dutdlgd5uj [ 1 ] ; localB ->
m1dnlxpmmu [ 2 ] = localDW -> dutdlgd5uj [ 2 ] ; LC_core_control ( &
eqhwqmkirz [ 0 ] , & localB -> lqqbomot3p [ 0 ] , hf3ixuspm0 , & krb0v5ajkv [
0 ] , & localB -> m1dnlxpmmu [ 0 ] , f5cfhvhrbc , & localB -> f3jjb1zpk0 [ 0
] , & ln0dqujal1 [ 0 ] , & localB -> kryi4th5qr [ 0 ] , & gitnbltvi4 [ 0 ] ,
& ( localDW -> etqgqqb2ch . rtdw ) ) ; } DC_core_control ( ovryma2hyb ,
jfi3kzdglc , ol11pn4kwk , & i0etnm3dja , & h50zc0nhds , & itjeggky5b , & (
localDW -> fj2mqrj3is . rtb ) , & ( localDW -> fj2mqrj3is . rtdw ) ) ; if ( *
ol11pn4kwk ) { localB -> kmvl2cntou [ 0 ] = itjeggky5b ; localB -> kmvl2cntou
[ 1 ] = itjeggky5b ; localB -> kmvl2cntou [ 2 ] = itjeggky5b ; } else {
localB -> kmvl2cntou [ 0 ] = 0.0F ; localB -> kmvl2cntou [ 1 ] = 0.0F ;
localB -> kmvl2cntou [ 2 ] = 0.0F ; } if ( rtmIsSampleHit ( ob2yydonjz , 1 ,
0 ) ) { HC_core_compensation_all ( & cpyvmcwh5j [ 0 ] , & flqoyfer1o [ 0 ] ,
jb0o103acl , & rtP__shuntHarmonicsCorrected2f2fmuGenerationDictionay_sldd_ [
0 ] , & lawg0znqbs [ 0 ] , & gegp3clne1 [ 0 ] , & localB -> dgg0ublhbc [ 0 ]
, & a33f40die0 [ 0 ] , & ca0kl33vdf [ 0 ] , & gvlxlfgdtw [ 0 ] , & ( localDW
-> ceec0oyspz . rtb ) , & ( localDW -> ceec0oyspz . rtdw ) ) ; I_core_limit (
& ( localDW -> piei4df4ag . rtm ) , & localB -> kmvl2cntou [ 0 ] , &
ln0dqujal1 [ 0 ] , & gitnbltvi4 [ 0 ] , & gvlxlfgdtw [ 0 ] , & localB ->
g5qpgrulyl [ 0 ] , & localB -> gn3eogbz4c [ 0 ] , & localB -> bewjwmhgom [ 0
] , & jb2n1bdqh4 [ 0 ] , & ( localDW -> piei4df4ag . rtb ) , & ( localDW ->
piei4df4ag . rtdw ) ) ; } localB -> bgo01pn45m [ 0 ] = localB -> kmvl2cntou [
0 ] + localB -> f3jjb1zpk0 [ 0 ] ; localB -> bgo01pn45m [ 1 ] = localB ->
kmvl2cntou [ 1 ] + localB -> f3jjb1zpk0 [ 1 ] ; localB -> bgo01pn45m [ 2 ] =
localB -> kmvl2cntou [ 2 ] + localB -> f3jjb1zpk0 [ 2 ] ; Idq_core_control (
alxctb32kf , & localB -> bgo01pn45m [ 0 ] , & localB -> kryi4th5qr [ 0 ] , &
nrxmxjtuyd [ 0 ] , & cezjmq5x5p [ 0 ] , & jwyg0c0j3g [ 0 ] , & bd1l2vd1co [ 0
] , & aekw34ae0j [ 0 ] , & jvffilbxtv [ 0 ] , & gftynocchu [ 0 ] , &
md2xx4ryau [ 0 ] , & ( localDW -> cv5n1d2u0p . rtb ) , & ( localDW ->
cv5n1d2u0p . rtdw ) , & ( localDW -> cv5n1d2u0p . rtzce ) ) ; } void
SH_core_controlTID2 ( o0dgt5t3tx * localDW ) { LC_core_controlTID1 ( & (
localDW -> etqgqqb2ch . rtdw ) ) ; I_core_limitTID1 ( & ( localDW ->
piei4df4ag . rtb ) , & ( localDW -> piei4df4ag . rtdw ) ) ;
DC_core_controlTID1 ( & ( localDW -> fj2mqrj3is . rtb ) ) ; } void ktdw0mx3kq
( g0zk2atzxj * const ob2yydonjz , const boolean_T * ol11pn4kwk , ftsh5sbept *
localB , o0dgt5t3tx * localDW ) { if ( rtmIsSampleHit ( ob2yydonjz , 1 , 0 )
) { memcpy ( & localDW -> nng2bawhua [ 0 ] , & localB -> g5qpgrulyl [ 0 ] ,
18U * sizeof ( real32_T ) ) ; localDW -> aa5ydd4hrb [ 0 ] = localB ->
gn3eogbz4c [ 0 ] ; localDW -> aa5ydd4hrb [ 1 ] = localB -> gn3eogbz4c [ 1 ] ;
localDW -> aa5ydd4hrb [ 2 ] = localB -> gn3eogbz4c [ 2 ] ; localDW ->
dutdlgd5uj [ 0 ] = localB -> bewjwmhgom [ 0 ] ; localDW -> dutdlgd5uj [ 1 ] =
localB -> bewjwmhgom [ 1 ] ; localDW -> dutdlgd5uj [ 2 ] = localB ->
bewjwmhgom [ 2 ] ; kstupqmgsy ( & ( localDW -> etqgqqb2ch . rtdw ) ) ; }
jek00gbgan ( ol11pn4kwk , & ( localDW -> fj2mqrj3is . rtb ) , & ( localDW ->
fj2mqrj3is . rtdw ) ) ; if ( rtmIsSampleHit ( ob2yydonjz , 1 , 0 ) ) {
d5cxoj21dh ( & ( localDW -> ceec0oyspz . rtdw ) ) ; } i0vombvibb ( & (
localDW -> cv5n1d2u0p . rtb ) , & ( localDW -> cv5n1d2u0p . rtdw ) ) ; } void
bl0nzwyhlh ( o0dgt5t3tx * localDW , g0zk2atzxj * const ob2yydonjz ) {
...
rtdw ) , & ( localDW -> ceec0oyspz . rtm ) ) ; l242pzq2ig ( & ( localDW ->
cv5n1d2u0p . rtm ) ) ; if ( ! slIsRapidAcceleratorSimulating ( ) ) {
...
i ++ ) { localB -> g5qpgrulyl [ i ] = 0.0F ; } localB -> lqqbomot3p [ 0 ] =
...
localB -> kryi4th5qr [ 0 ] = 0.0F ; localB -> kryi4th5qr [ 1 ] = 0.0F ;
localB -> kryi4th5qr [ 2 ] = 0.0F ; localB -> kmvl2cntou [ 0 ] = 0.0F ;
localB -> kmvl2cntou [ 1 ] = 0.0F ; localB -> kmvl2cntou [ 2 ] = 0.0F ;
localB -> gn3eogbz4c [ 0 ] = 0.0F ; localB -> gn3eogbz4c [ 1 ] = 0.0F ;
localB -> gn3eogbz4c [ 2 ] = 0.0F ; localB -> bewjwmhgom [ 0 ] = 0.0F ;
localB -> bewjwmhgom [ 1 ] = 0.0F ; localB -> bewjwmhgom [ 2 ] = 0.0F ;
localB -> bgo01pn45m [ 0 ] = 0.0F ; localB -> bgo01pn45m [ 1 ] = 0.0F ;
localB -> bgo01pn45m [ 2 ] = 0.0F ; } ( void ) memset ( ( void * ) localDW ,
...
; gqkdhuz13j ( _mdlRefSfcnS , mdlref_TID0 , & ( localDW -> cv5n1d2u0p . rtm )
, & ( localDW -> cv5n1d2u0p . rtb ) , & ( localDW -> cv5n1d2u0p . rtdw ) , &
( localDW -> cv5n1d2u0p . rtzce ) , ob2yydonjz -> DataMapInfo . systemRan [ 0
] , ob2yydonjz -> DataMapInfo . systemTid [ 0 ] , & ( ob2yydonjz ->
DataMapInfo . mmi ) , "SH_core_control/Model3" , 4 , - 1 ) ; if ( (
...
retVal = 0 ; mr_Idq_core_control_MdlInfoRegFcn ( mdlRefSfcnS ,
"Idq_core_control" , retVal ) ; if ( * retVal == 0 ) return ; * retVal = 0 ;
} } * retVal = 0 ; ssRegModelRefMdlInfo ( mdlRefSfcnS , modelName ,
rtMdlInfo_SH_core_control , 50 ) ; * retVal = 1 ; } static void
...
"mdlrefDW->rtdw.cv5n1d2u0p" , "mdlrefDW->rtdw.nng2bawhua" ,
"mdlrefDW->rtdw.aa5ydd4hrb" , "mdlrefDW->rtdw.dutdlgd5uj" , } ; mxArray *
rtdwData = mxCreateStructMatrix ( 1 , 1 , 8 , rtdwDataFieldNames ) ; {
mxArray * varData = mr_LC_core_control_GetDWork ( & ( mdlrefDW -> rtdw .
etqgqqb2ch ) ) ; mxSetFieldByNumber ( rtdwData , 0 , 0 , varData ) ; } {
mxArray * varData = mr_DC_core_control_GetDWork ( & ( mdlrefDW -> rtdw .
fj2mqrj3is ) ) ; mxSetFieldByNumber ( rtdwData , 0 , 1 , varData ) ; } {
mxArray * varData = mr_HC_core_compensation_all_GetDWork ( & ( mdlrefDW ->
rtdw . ceec0oyspz ) ) ; mxSetFieldByNumber ( rtdwData , 0 , 2 , varData ) ; }
{ mxArray * varData = mr_I_core_limit_GetDWork ( & ( mdlrefDW -> rtdw .
piei4df4ag ) ) ; mxSetFieldByNumber ( rtdwData , 0 , 3 , varData ) ; } {
mxArray * varData = mr_Idq_core_control_GetDWork ( & ( mdlrefDW -> rtdw .
cv5n1d2u0p ) ) ; mxSetFieldByNumber ( rtdwData , 0 , 4 , varData ) ; }
mr_SH_core_control_cacheDataAsMxArray ( rtdwData , 0 , 5 , ( const void * ) &
( mdlrefDW -> rtdw . nng2bawhua ) , sizeof ( mdlrefDW -> rtdw . nng2bawhua )
) ; mr_SH_core_control_cacheDataAsMxArray ( rtdwData , 0 , 6 , ( const void *
) & ( mdlrefDW -> rtdw . aa5ydd4hrb ) , sizeof ( mdlrefDW -> rtdw .
aa5ydd4hrb ) ) ; mr_SH_core_control_cacheDataAsMxArray ( rtdwData , 0 , 7 , (
...
mr_Idq_core_control_SetDWork ( & ( mdlrefDW -> rtdw . cv5n1d2u0p ) ,
mxGetFieldByNumber ( rtdwData , 0 , 4 ) ) ;
mr_SH_core_control_restoreDataFromMxArray ( ( void * ) & ( mdlrefDW -> rtdw .
nng2bawhua ) , rtdwData , 0 , 5 , sizeof ( mdlrefDW -> rtdw . nng2bawhua ) )
; mr_SH_core_control_restoreDataFromMxArray ( ( void * ) & ( mdlrefDW -> rtdw
. aa5ydd4hrb ) , rtdwData , 0 , 6 , sizeof ( mdlrefDW -> rtdw . aa5ydd4hrb )
) ; mr_SH_core_control_restoreDataFromMxArray ( ( void * ) & ( mdlrefDW ->
rtdw . dutdlgd5uj ) , rtdwData , 0 , 7 , sizeof ( mdlrefDW -> rtdw .
dutdlgd5uj ) ) ; } } void mr_SH_core_control_RegisterSimStateChecksum (
SimStruct * S ) { const uint32_T chksum [ 4 ] = { 2252218696U , 789638803U ,
296341802U , 3197474132U , } ; slmrModelRefRegisterSimStateChecksum ( S ,
...
mr_Idq_core_control_RegisterSimStateChecksum ( S ) ;
...
mr_Idq_core_control_GetSimStateDisallowedBlocks ( ) ; disallowedBlocksInChild
[ 4 ] = mr_LC_core_control_GetSimStateDisallowedBlocks ( ) ; { size_t i ; for
