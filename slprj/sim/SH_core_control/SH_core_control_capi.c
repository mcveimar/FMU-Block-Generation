...
rtcapiStoredFloats [ ] = { 0.00853344 , 0.0 } ; static rtwCAPI_FixPtMap
...
, 0 , ( NULL ) , 0 } , { ( NULL ) , 0 , ( NULL ) , 0 } , { rtBlockStates , 3
} , { rtDataTypeMap , rtDimensionMap , rtFixPtMap , rtElementMap ,
rtSampleTimeMap , rtDimensionArray } , "float" , { 1516570400U , 1206063554U
, 1244422955U , 3834901543U } , & mmiStaticInfoLogging , 0 , ( boolean_T ) 0
, rt_LoggedStateIdxList } ; const rtwCAPI_ModelMappingStaticInfo *
SH_core_control_GetCAPIStaticMap ( void ) { return & mmiStatic ; }
#ifndef HOST_CAPI_BUILD
...
ob2yydonjz -> DataMapInfo . mmi , 5 ) ; SH_core_control_InitializeSystemRan (
...
, "SH_core_control/Model2" ) ; dataMap -> childMMI [ 4 ] = & ( dataMap ->
child4 . mmi ) ; Idq_core_control_host_InitializeDataMapInfo ( & ( dataMap ->
child4 ) , "SH_core_control/Model3" ) ; rtwCAPI_SetChildMMIArray ( dataMap ->
